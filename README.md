...
- The following are the short set up steps to start a Django project
	...
	1.	Install Django, I used version 3.2.  In the IDE terminal type the following commands:
		...
		- django-admin startproject bookworms_et_al . (the dot is very important after the project name as it sets up all the files for the project!)
...
My site is deployed using Heroku - [Bookworms et al](https://mym-bookworms-et-al-b7ea61e35a6e.herokuapp.com/)
...
- Navigate to [my Github Repository](https://github.com/MoniMurray/bookworms-et-al) 
...
You can see all this code in my [settings.py](bookworms_et_al/settings.py) in this repo.
